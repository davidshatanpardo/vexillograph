...
questions.push({
	...
	type: questiontype.RADIO,
	answers: [
		{text: "hot and dry", smalltext: "", values: [/*SIZE*/0, /*AGE*/0, /*FUNCT*/0, /*LIGHT*/5, /*TEMP*/5, /*SAT*/1, /*ORG*/0, /*POS*/0] }, 
		{text: "hot and wet", smalltext: "", values: [/*SIZE*/0, /*AGE*/0, /*FUNCT*/0, /*LIGHT*/-5, /*TEMP*/5, /*SAT*/-1, /*ORG*/0, /*POS*/0] }, 
		{text: "cold and dry", smalltext: "", values: [/*SIZE*/0, /*AGE*/0, /*FUNCT*/0, /*LIGHT*/5, /*TEMP*/-5, /*SAT*/1, /*ORG*/0, /*POS*/0] },
		{text: "cold and wet", smalltext: "", values: [/*SIZE*/0, /*AGE*/0, /*FUNCT*/0, /*LIGHT*/-5, /*TEMP*/-5, /*SAT*/-1, /*ORG*/0, /*POS*/0] },
...
function generate() {
    ...
    if (values[7]<=-1){
        ...
        console.log(light1);
        sat1 = sat1 + (values[5]*3) + (values[7]*3) + 2;
        console.log(sat1);

        light2 = light2 + (values[3]*3) + (values[7]*3) - 10;
        console.log(light2);
        sat2 = sat2 + (values[5]*3) + (values[7]*3) + 2;
        console.log(sat2);

        light3 = light3 + (values[3]*3) + (values[7]*3) - 10;
        console.log(light3);
        sat3 = sat3 + (values[5]*3) + (values[7]*3) + 2;
        console.log(sat3);

        light4 = light4 + (values[3]*3) + (values[7]*3) - 10;
        console.log(light4);
        sat4 = sat4 + (values[5]*3) + (values[7]*3) + 2;
        console.log(sat4);
    }
